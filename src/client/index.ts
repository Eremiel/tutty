...
socket.on('connect', () => {
  ...
  if ( terminalElement === null ) {
    throw new Error('HTML does not contain a "terminal" element.');
  }
  ...
  const editor = document.querySelector('#options .editor') as HTMLTextAreaElement;
  if ( editor === null ) {
    throw new Error('HTML does not contain a "options" element.');
  }
  editor.value = code;
